...
public class Analysis3 implements ActionListener{
	JFrame f;
	JLabel l1;
	static JLabel l2;
	static JLabel l3;
...
public static int[][] getCentroid(int data[],int noofclusters,int centroid[][]){
		...
		String names[] = {"Least Commented","Moderately Commented","Most Commented"};
		...
		if(isAchived){
			...
			for(int i=0;i<noofclusters;i++){	
				...
				if(i==0){
					val[0]=cnt1;
					l3.setText("Least Commented :" + Integer.toString(cnt1));
				}else if(i==1){
					val[1]=cnt1;
					l4.setText("Moderately Commented :" + Integer.toString(cnt1));
				}else if(i==2){
					val[2]=cnt1;
					l5.setText("Most Commented :" + Integer.toString(cnt1));
				}
	...
	public void show(){
		Cluster cluster = Cluster.builder().addContactPoint("127.0.0.1").build();
	     ...
	     String cql = "SELECT video_id,comment_count FROM youtube";
	     ...
	     String tmp;
	        for(Row r : result)
	        {
	        	...
	        	data[i] = Integer.parseInt(r.getString("comment_count"));
	        	i++;
