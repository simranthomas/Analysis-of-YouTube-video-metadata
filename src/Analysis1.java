...
public class Analysis1 implements ActionListener{
	JFrame f;
	JLabel l1;
	static JLabel l2;
	static JLabel l3;
...
public static int[][] getCentroid(int data[],int noofclusters,int centroid[][]){
		...
		String names[] = {"Least Liked","Moderately Liked","Most Liked"};
		...
		if(isAchived){
			...
			for(int i=0;i<noofclusters;i++){	
				...
				if(i==0){
					val[0]=cnt1;
					l3.setText("Least Liked : " + Integer.toString(cnt1));
				}else if(i==1){
					val[1]=cnt1;
					l4.setText("Moderately Liked : " + Integer.toString(cnt1));
				}else if(i==2){
					val[2]=cnt1;
					l5.setText("Most Liked : " + Integer.toString(cnt1));
				}
	...
	public void show(){
		Cluster cluster = Cluster.builder().addContactPoint("127.0.0.1").build();
	     ...
	     String cql = "SELECT video_id, likes FROM youtube";
	     ...
	     String tmp;
	        for(Row r : result)
	        {
	        	tmp = r.getString("likes");
	        	
	        	data[i] = Integer.parseInt(r.getString("likes"));
	        	i++;
